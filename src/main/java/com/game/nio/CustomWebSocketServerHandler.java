...
public class CustomWebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
...
//	    }  
	    ...
	    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {  
	        LogUtil.error("WebSocket异常", cause);  
	        ctx.close();  
	        LogUtil.info(sessionId + "  注销");  
